...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(249,250,251,1); max-width:540px; border-radius:20px; border-width:1px; border-color:#c3bebe; border-style:solid; direction:ltr">
      <form id="sib-form" method="POST" action="https://c454d84b.sibforms.com/serve/MUIFAOqHfO_nHTui2BwvjpLvq2ac4a2m46GtxjxkFZ0jFV0E76Z0k5pjZ0xSdbaKqox6sFQJbvm2U5ESSzhLuAngIOIo8CM9T-BREO16pUY23yTOq5n3c7GkkFjI8Z5_TxcJ5DPqpowKSyFbJBvTAuhRBLSKgdu2HKcL6XkeEoyxdDUtC0jO1WQxkVNI5b-z3uwRdXLVEKS7lgbv" data-type="subscription">
        ...
        <div style="padding: 16px 0;">
          <div class="sib-optin sib-form-block" data-required="true">
            ...
            ></span><span style="font-size:12px; text-align:left; font-family:Helvetica, sans-serif; color:#121c2d; background-color:transparent;"><p>Oui, je veux recevoir l’Hebdo IA Québec et rester conforme à la Loi 25.</p></span> </label>
              ...
              <label class="entry__specification" style="font-size:12px; text-align:left; font-family:Inter, webFonts; color:#f9fafb; text-align:left">
...
const NewsletterFormPage: React.FC = () => {
  useEffect(() => {
    ...
    const ensureInHead = (selector: string, create: () => HTMLElement) => {
    ...
    const ensureInBody = (selector: string, create: () => HTMLElement) => {
      const existing = document.body.querySelector<HTMLElement>(selector);
      if (existing) {
        return existing;
      }
      const node = create();
    ...
    ensureInHead('style[data-newsletter-form="brevo-style"]', () => {
      const style = document.createElement('style');
      style.dataset.newsletterForm = 'brevo-style';
      style.innerHTML = headStyle;
      return style;
    });

    ensureInHead('link[data-newsletter-form="brevo-css"]', () => {
      const link = document.createElement('link');
      link.rel = 'stylesheet';
      link.href = 'https://sibforms.com/forms/end-form/build/sib-styles.css';
      link.dataset.newsletterForm = 'brevo-css';
      return link;
    });

    ensureInHead('link[data-newsletter-form="brevo-inter-font"]', () => {
      const link = document.createElement('link');
      link.rel = 'stylesheet';
      link.href = 'https://fonts.googleapis.com/css2?family=Inter&&display=swap';
      link.dataset.newsletterForm = 'brevo-inter-font';
      return link;
    });

    ensureInBody('script[data-newsletter-form="brevo-inline-config"]', () => {
      const script = document.createElement('script');
      script.type = 'text/javascript';
      script.dataset.newsletterForm = 'brevo-inline-config';
      script.innerHTML = inlineScriptContent;
      return script;
    });

    ensureInBody('script[data-newsletter-form="brevo-main"]', () => {
      const script = document.createElement('script');
      script.src = 'https://sibforms.com/forms/end-form/build/main.js';
      script.defer = true;
      script.dataset.newsletterForm = 'brevo-main';
      return script;
    });

    ensureInBody('script[data-newsletter-form="brevo-recaptcha"]', () => {
      const script = document.createElement('script');
      script.src = 'https://www.google.com/recaptcha/api.js?render=6Lf0RtYrAAAAAMnsVvJx3DTeKDVGi2ZQElXygdM-&hl=en';
      script.async = true;
      script.defer = true;
      script.dataset.newsletterForm = 'brevo-recaptcha';
      return script;
    });
  ...
  return (
    <div className="min-h-screen bg-[#121c2d] py-16">
