...
const ProofLab = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="projects"
      className="relative overflow-hidden py-24 lg:py-32 bg-[#0B1320] bg-gradient-to-br from-[#139E9C]/40 via-[#0B1320] to-[#0B1320]"
    >
          ...
          {cards.map((card, index) => {
            ...
            return (
              <article
                ...
                } hover:-translate-y-[2px] hover:border-white/20 hover:bg-slate-900/60 hover:opacity-95 hover:shadow-[0_24px_60px_rgba(10,20,45,0.6)]`}
